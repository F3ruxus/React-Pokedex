// Below is a list of the first 100 pokemon
...
// Each pokemon type has a respective color.
...
// This function is to get the pokedex number
// Javascript starts at 0, but pokemon starts at one
// That's why we add one.
export function getPokedexNumber(index) {
    return index + 1
}

// This function is needed to get the full pokedex number
